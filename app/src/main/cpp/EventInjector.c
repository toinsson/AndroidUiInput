...
#include "../../../../../../../../Android/Sdk/ndk-bundle/platforms/android-22/arch-mips/usr/include/linux/uinput.h"
...
jint Java_toinsson_uiinput_Events_intEnableDebug(JNIEnv* env, jobject thiz,
		jint enable) {
...
jint Java_toinsson_uiinput_Events_sendVirtualEvent(JNIEnv* env,
...
jint Java_toinsson_uiinput_Events_intSendEvent(JNIEnv* env, jobject thiz,
...
jint Java_toinsson_uiinput_Events_ScanFiles(JNIEnv* env, jobject thiz) {
...
jstring Java_toinsson_uiinput_Events_getDevPath(JNIEnv* env, jobject thiz,
		jint index) {
	return (*env)->NewStringUTF(env, pDevs[index].device_path);
}
jstring Java_toinsson_uiinput_Events_getDevName(JNIEnv* env, jobject thiz,
		jint index) {
...
jint Java_toinsson_uiinput_Events_getTime(JNIEnv* env, jobject thiz) {
	return event.time.tv_sec * 1000 + (event.time.tv_usec / 1000);
}

jint Java_toinsson_uiinput_Events_OpenDev(JNIEnv* env, jobject thiz,
		jint index) {
	return open_device(index);
}
jint Java_toinsson_uiinput_Events_takeOverDevice(JNIEnv* env, jobject thiz,
...
jint Java_toinsson_uiinput_Events_RemoveDev(JNIEnv* env, jobject thiz,
		jint index) {
	if (index == 2)
...
jint Java_toinsson_uiinput_Events_PollDev(JNIEnv* env, jobject thiz,
		jint index) {
	if (index >= nDevsCount || pDevs[index].ufds.fd == -1)
		return -1;
...
jint Java_toinsson_uiinput_Events_getType(JNIEnv* env, jobject thiz) {
	return event.type;
}

jint Java_toinsson_uiinput_Events_getCode(JNIEnv* env, jobject thiz) {
	return event.code;
}

jint Java_toinsson_uiinput_Events_getCode2(JNIEnv* env, jobject thiz) {
	return 0;
	//return startDevice();
}

jint Java_toinsson_uiinput_Events_createVirtualDevice(
...
jint Java_toinsson_uiinput_Events_getValue(JNIEnv* env, jobject thiz) {
	return event.value;
}
